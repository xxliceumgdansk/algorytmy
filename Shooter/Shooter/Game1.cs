...
namespace Shooter
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            przyciskiText[0] = Content.Load<Texture2D>("Graj.png");
            przyciskiText[1] = Content.Load<Texture2D>("Wyjdz.png");

            bronieText[0] = Content.Load<Texture2D>("Pistolet.png");
            bronieText[1] = Content.Load<Texture2D>("Karabin.png");
            bronieText[2] = Content.Load<Texture2D>("Minigun.png");
            bronieText[3] = Content.Load<Texture2D>("Strzelba.png");
            bronieText[4] = Content.Load<Texture2D>("Snajpa.png");
            bronieText[5] = Content.Load<Texture2D>("Laser.png");

            pociskiText[0] = Content.Load<Texture2D>("PociskZwykly.png");
            pociskiText[1] = Content.Load<Texture2D>("PociskLaser.png");

            zycieGracz[0] = Content.Load<Texture2D>("Serce.png");
            zycieGracz[1] = Content.Load<Texture2D>("Niesmiertelnosc.png");

            textury[0] = Content.Load<Texture2D>("Tlo.png");
            textury[1] = Content.Load<Texture2D>("GraczPrawo.png");
            textury[2] = Content.Load<Texture2D>("GraczLewo.png");
            textury[3] = Content.Load<Texture2D>("Platforma.png");
            textury[4] = Content.Load<Texture2D>("Chodzacy.png");
            textury[5] = Content.Load<Texture2D>("Rage.png");
            textury[6] = Content.Load<Texture2D>("HP3.png");
            textury[7] = Content.Load<Texture2D>("HP2.png");
            textury[8] = Content.Load<Texture2D>("HP1.png");
            textury[9] = Content.Load<Texture2D>("Box.png");
